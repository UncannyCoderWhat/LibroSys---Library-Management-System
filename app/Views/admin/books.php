...
<body>
    ...
    <main class="content-workspace">
        ...
        <!-- Books Table -->
        <section class="activity-section" style="margin-top: 0;"><div class="section-header"><h2 class="section-title" style="margin:0"><i class="fa-solid fa-book"></i> Library Collection</h2><span style="font-size:13px;color:#888" id="resultCount"><?php echo count($all_books??[]);?> book(s)</span></div>
